...
public:
	...
	virtual void QueryZoomPos(pPelco Ppkt, UINT8 byAddress = 0){};
	virtual void QueryPanPos(pPelco Ppkt, UINT8 byAddress = 0){};
	virtual void QueryTiltPos(pPelco Ppkt, UINT8 byAddress = 0){};
	...
	virtual void MakeSetZoomPos(pPelco Ppkt, UINT16 byValue, UINT8 byAddress /* = 0 */){};
