...
public:
	...
	void MakeCameraOn(pPelco Ppkt, UINT8 byAddress = 0);
	 ...
	 void QueryZoomPos(pPelco Ppkt, UINT8 byAddress = 0);
	 void QueryPanPos(pPelco Ppkt, UINT8 byAddress = 0);
	 void QueryTiltPos(pPelco Ppkt, UINT8 byAddress = 0);
	...
	// EXTENDED COMMANDS
	 ...
	 void MakeSetZoomPos(pPelco Ppkt, UINT16 byValue, UINT8 byAddress /* = 0 */);
