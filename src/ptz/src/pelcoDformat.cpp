...
void IPelcoDFormat::QueryZoomPos(pPelco Ppkt, UINT8 byAddress)
{
	LPPELCO_D_REQPKT pPkt = (LPPELCO_D_REQPKT) Ppkt;
	if(pPkt == NULL)
		return ;
...
void IPelcoDFormat::QueryPanPos(pPelco Ppkt, UINT8 byAddress)
{
	LPPELCO_D_REQPKT pPkt = (LPPELCO_D_REQPKT) Ppkt;
	if(pPkt == NULL)
		return ;
...
void IPelcoDFormat::QueryTiltPos(pPelco Ppkt, UINT8 byAddress)
{
	LPPELCO_D_REQPKT pPkt = (LPPELCO_D_REQPKT) Ppkt;
	if(pPkt == NULL)
		return ;
...
void IPelcoDFormat::MakeSetZoomPos(pPelco Ppkt, UINT16 byValue, UINT8 byAddress /* = 0 */)
{
	LPPELCO_D_REQPKT pPkt = (LPPELCO_D_REQPKT) Ppkt;
	if(pPkt == NULL)
		return ;
