...
public:
	...
	void two_State_PlantForm_SceneTrk();
...
//
	...
	const bool isTwo_PlantForm_SceneTrk()
	{
		return Two_Mode == STATE_PLANTFORM_sceneTRK;
	}
//
...
//
	...
	const bool isBOX_Move()
	{
		return BOX_ipc == BOX_MOVE;
	}
};
